...
comes from high transmission delay from Process~A to Process~B, and from
...
buffers. It solves the issue from the buffer owner's perspective. 
\TODO{todo Here. todo drawbacks (too many retry, we forfeit) what does it imply?} 

\begin{figure*}
  \begin{center}
    \subfloat[Part A][Process~A wanted to add a link to Process~D after having
    broadcast $a$. Afterwards, it broadcast $a'$ and $a''$.]
    {\input{input/figbuffersolveA.tex}}
    \hspace{20pt}
    \subfloat[Part B][Process~A wanted to add a link to Process~D after having
    broadcast $a$. Afterwards, it broadcast $a'$ and $a''$.]
    {\input{input/figbuffersolveB.tex}}
    \hspace{20pt}
    \subfloat[Part C][Process~A wanted to add a link to Process~D after having
    broadcast $a$. Afterwards, it broadcast $a'$ and $a''$.]
    {\input{input/figbuffersolveC.tex}}
    \hspace{20pt}
    \subfloat[Part D][Process~A wanted to add a link to Process~D after having
    broadcast $a$. Afterwards, it broadcast $a'$ and $a''$.]
    {\input{input/figbuffersolveD.tex}}
    \hspace{20pt}
    \subfloat[Part E][Process~A wanted to add a link to Process~D after having
    broadcast $a$. Afterwards, it broadcast $a'$ and $a''$.]
...
% It aims to bound the size of buffers and handle
