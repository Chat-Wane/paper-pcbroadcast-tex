...
message exactly once. \TODO{Function alreadyReceived}.
...
\begin{theorem}[\label{theo:static}FIFO-based causal broadcast in static networks]
  \TODO{blablabla.}
\end{theorem}
...
of messages except if it generates network partitions. \TODO{Theorem.}

\begin{theorem}[FIFO-based causal broadcast in network subject to link removals]
  \TODO{blablabla}
\end{theorem}
...
\begin{theorem}[FIFO-based causal broadcast in network subject to link additions]
\TODO{Adding a channel may result in causal ordering violation.}
\end{theorem}

\begin{proof}
  \TODO{example of Figure~\ref{fig:problem}}
\end{proof}
