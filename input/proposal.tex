...
messages \TODO{HERERERERE.}


We show that this property does not hold when links are added to the network. It
does not support dynamic networks. We propose a causal broadcast that works in
such settings.
...
\begin{proof}
  ...
  uniform agreement, uniform integrity, and causal order. \\
