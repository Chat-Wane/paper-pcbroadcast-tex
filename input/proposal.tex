...
\begin{figure*}
  \begin{center}
    \subfloat[part A][Slow locked message $\ell$.]
    {\input{input/figbufferproblemA.tex}}
    \hspace{20pt}
    \subfloat[part B][Process~D crashes.]
    {\input{input/figbufferproblemB.tex}}
    \hspace{20pt}
    \subfloat[part C][Acknowledgment $\alpha$ fails.]
    {\input{input/figbufferproblemC.tex}}
    \caption{Buffers may grow unbounded due to network conditions.}
  \end{center}
\end{figure*}
