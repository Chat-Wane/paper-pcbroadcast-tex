...
\CBROADCAST's most important feature is its constant size message
overhead. 

In this section, we evaluate the impact of \CBROADCAST on
the message delivery in a specific overlay network that corresponds to random
graphs. The experiments run on the \PEERSIM
...
Github platform at \url{http://github.com/chat-wane/peersim-pcbroadcast}.
