...
\begin{figure*}
  \begin{center}
    \subfloat[Part 1][\label{fig:preventiveproblemA}Process~A broadcasts $a$.]{\input{input/figpreventiveproblemA.tex}}\hspace{20pt}
    \subfloat[Part 2][\label{fig:preventiveproblemB}Process~A creates a link to $D$ and broadcasts $a'$.]{\input{input/figpreventiveproblemB.tex}}\hspace{20pt}
    \subfloat[Part 3][\label{fig:preventiveproblemC}Process~D receives and delivers $a'$ before $a$ violating causal order.]{\input{input/figpreventiveproblemC.tex}}
