...
constant~\cite{friedman2004causal,bravo2017saturn}. State-of-the-art does not
...
dynamic systems. Our approach provides a lightweight and efficient mean to
reconfigure dissemination paths using local knowledge without impairing causal
order.  Saturn~\cite{bravo2017saturn} along with \CBROADCAST could ease the
former's online changes in configuration.
